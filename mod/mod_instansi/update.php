...
?>
<form action="mod/mod_instansi/action.php?update" method="POST" class="form-horizontal form-label-left">

	<div class="form-group">
		<label class="control-label col-md-2 col-sm-2 col-xs-2">Nama Instansi</label>
		<div class="col-md-4 col-sm-4 col-xs-4">
			<input type="text" class="form-control" name="Nama_Instansi" value="<?php echo $data['Nama_Instansi']; ?>" id="inputSuccess2" >
