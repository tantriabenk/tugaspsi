...
?>
<form action="mod/mod_golongan/action.php?update" method="POST" class="form-horizontal form-label-left">

	<div class="form-group">
		<label class="control-label col-md-2 col-sm-2 col-xs-2">Nama Jabatan</label>
		<div class="col-md-4 col-sm-4 col-xs-4">
			<input type="text" class="form-control" name="Nama_Golongan" value="<?php echo $data['Nama_Golongan']; ?>" id="inputSuccess2" >
